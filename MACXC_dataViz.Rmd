...
We can also calculate the average gap between the 1st and 5th runner for the entire year, which ended up being about 1 minute and 15 seconds.
...
Now that we have information on all four years, we can determine which Mac Pack team in this four year span was the "best" in terms of gap between the first and last runners who score. We group by year and find the average gap for every meet for every year and visualize the results in a bar plot. We can see that during my four years at Macalester, the "best" team was in 2018 with an average gap of about 50 seconds, followed by the 2019 team with an average gap of about 1 minute and 15 seconds.
...
plot.set_title("Range of 8K Times for Class of 2020 Runners", fontsize = 15)
plot.set_xlabel("Runner")
