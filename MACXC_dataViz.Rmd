...
sns.barplot(x="LASTNAME", y="Race Time", hue= "Type", data= seniors_best.set_index("LASTNAME").stack().reset_index().rename(columns = {0:"Race Time", "level_1":"Type"}))
```
...
sns.boxplot(x= "LASTNAME", y= "TIME", data = seniors_8K)
```
